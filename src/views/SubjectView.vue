<template>
	<div class="subject-view has-reader">
		<banner title="聊聊你的感受"></banner>
		<template v-if="!showLoading">
			<div class="subject-card">
				...
				<div class="subject-info">
					<div class="right">
						<a href="#">
							<img :src="subject.images.large" v-if="subject.images" alt="cover">
						</a>
					</div>
					<div class="left" v-if="subject.rating">
						<rating :rating="subject.rating">
							<span slot ="ratingsCount">{{subject.rating_count}}人评价</span>
						</rating>
				...
				<div class="subject-intro">
					...
					<p>
						...
						<a href="javascript:;" v-show="isExpand" @click="expand">
							(展开)
						</a>
					</p>
				</div>
